...
final class ActionSheetCancelActionView: UIView {
    ...
    private var action: ChallengeViewAction!
    private var visualStyle: ChallengeViewVisualStyle!

    var cancelTapHandler: ((ChallengeViewAction) -> Void)?
    ...
    func buildView(cancelAction: ChallengeViewAction, visualStyle: ChallengeViewVisualStyle) {
    ...
    private func addCancelButton(action: ChallengeViewAction, visualStyle: ChallengeViewVisualStyle) {
