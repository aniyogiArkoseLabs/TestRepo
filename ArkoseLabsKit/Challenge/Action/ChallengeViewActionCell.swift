...
@objc(ChallengeViewActionCell)
@available(iOSApplicationExtension, unavailable)
final class ChallengeViewActionCell: UICollectionViewCell {
    ...
    func set(_ action: ChallengeViewAction, with visualStyle: ChallengeViewVisualStyle) {
...
final class ActionSeparatorView: UICollectionReusableView {
    ...
    override func apply(_ layoutAttributes: UICollectionViewLayoutAttributes) {
        ...
        if let attributes = layoutAttributes as? ChallengeViewCollectionViewLayoutAttributes {
