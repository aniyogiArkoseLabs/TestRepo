...
@objc(ChallengeViewAction)
@available(iOSApplicationExtension, unavailable)
public class ChallengeViewAction: NSObject {
    ...
    @objc
    public convenience init(title: String?, style: ChallengeViewAction.Style, handler: ((ChallengeViewAction) -> Void)? = nil)
    {
        self.init()
        self.title = title
        self.style = style
    ...
    public convenience init(attributedTitle: NSAttributedString?, style: ChallengeViewAction.Style,
        handler: ((ChallengeViewAction) -> Void)? = nil)
    {
        self.init()
    ...
    @objc
    public var handler: ((ChallengeViewAction) -> Void)?
    ...
    /// The action's style.
    @objc
    internal(set) public var style: ChallengeViewAction.Style = .normal
    ...
    var actionView: ChallengeViewActionCell? {
        didSet { self.actionView?.isEnabled = self.isEnabled }
    }
...
@available(iOSApplicationExtension, unavailable)
extension ChallengeViewAction {
    /// The action's style
    @objc(ChallengeViewActionStyle)
